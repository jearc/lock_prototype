...
LOCKS="USE_SPINLOCK_LOCKS USE_TTAS_LOCKS USE_MCS_LOCKS USE_CLH_LOCKS USE_ARRAY_LOCKS USE_TICKET_LOCKS USE_TTAS_SIMP_LOCKS USE_RW_LOCKS USE_RW_FAIR_LOCKS"

MAKE="";
UNAME=`uname`;
PF='PLATFORM=-DARM -DCORE_NUM=4 -DUSE_CDELAY'
if [ $UNAME = "Linux" ];
then
    MAKE=make;
